        ...
        $.ajax({
            ...
            success: function(t) {
                ...
                var data = {
                    ...
                    conventional: "北京、上海、广州、深圳",
                    hz_single: "杭州、成都、南京、西安、郑州、武汉、天津、济南、长沙、青岛、合肥、厦门、福州、宁波、沈阳、大连、太原、石家庄、海口、银川、哈尔滨、贵阳、南昌、西宁、长春、南宁、昆明、呼和浩特、兰州、湛江、珠海、佛山、汕头、阳江、漳州、江门、韶关、揭阳、三明、东莞、茂名、惠州、龙岩、潮州、中山、泉州、莆田、肇庆、宁德",
                    cq_single: "重庆",
                    wx_single: "苏州、无锡、常州、常熟、昆山、南通、扬州、镇江、徐州、金华、绍兴、嘉兴、湖州、洛阳、大同、丽水、连云港、盐城、泰州、唐山、潍坊、济宁、德州、威海、宿迁、绵阳、德阳、宜昌、襄阳、日照、莱芜、萍乡、黄石、荆州、舟山、淮安、温州、锦州、运城、汉中、渭南、新余、商丘、焦作、许昌、宝鸡、长治、临沂、邯郸、达州、义乌、衡阳、岳阳、常德、郴州、安庆、柳州、蚌埠、宿州、自贡、广元、娄底、益阳、株洲、烟台、三门峡、泸州、承德、淄博、濮阳、安阳、赤峰、新乡、十堰、景德镇、宜宾、淮南、赣州、九江、松原、佳木斯、黄冈、南阳、保定、芜湖、江阴、开封、湘潭、吉林、晋城、大庆、平顶山"
                };
